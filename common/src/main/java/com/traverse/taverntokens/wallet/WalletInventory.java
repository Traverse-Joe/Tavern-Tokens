...
public class WalletInventory implements Container {
    ...
    public WalletItemStack getItem(int slot) {
        try {
            ...
            ListTag lore = compound.getList("Lore", 9);

            lore.add(StringTag.valueOf("{\"text\":\"Total: " + original.getItemCount() + "\", \"color\":\"#f5d69d\",\"italic\":false}"));
    ...
    public void readNbtList(ListTag nbtList) {
        ...
        for (int i = 0; i < nbtList.size(); ++i) {
            ...
            stacks.set(i, WalletItemStack.fromNbt(compoundTag));
        }
    }
